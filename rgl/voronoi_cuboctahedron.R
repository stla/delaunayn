...
segments3d(rbind(c(-10.101,-10.101,-10.101), c(-9.101,-10.101,-10.101)), col=c("red","red"))
segments3d(rbind(c(-10.101,-10.101,-10.101), c(-11.101,-10.101,-10.101)), col=c("red","red"))
segments3d(rbind(c(-10.101,-10.101,-10.101), c(-10.101,-11.101,-10.101)), col=c("red","red"))
segments3d(rbind(c(-10.101,-10.101,-10.101), c(-10.101,-9.101,-10.101)), col=c("red","red"))
segments3d(rbind(c(-10.101,-10.101,-10.101), c(-1.0,0.0,0.0)))
...
segments3d(rbind(c(-0.5,-0.5,0.5), c(-1.0773502691896257,-1.0773502691896257,1.0773502691896257)), col=c("red","red"))
segments3d(rbind(c(-0.5,-0.5,0.5), c(-1.0,0.0,0.0)))
segments3d(rbind(c(-10.101,-10.101,-10.101), c(0.0,-1.0,0.0)))
...
segments3d(rbind(c(-0.5,0.5,0.5), c(-1.0773502691896257,1.0773502691896257,1.0773502691896257)), col=c("red","red"))
segments3d(rbind(c(-0.5,0.5,0.5), c(-1.0,0.0,0.0)))
segments3d(rbind(c(-10.101,-10.101,-10.101), c(0.0,0.0,1.0)))
segments3d(rbind(c(-10.101,-10.101,-10.101), c(0.0,0.0,1.0)))
segments3d(rbind(c(-10.101,-10.101,-10.101), c(-10.101,-10.101,-11.101)), col=c("red","red"))
segments3d(rbind(c(-0.5,-0.5,0.5), c(0.0,0.0,1.0)))
segments3d(rbind(c(-0.5,0.5,0.5), c(0.0,0.0,1.0)))
...
segments3d(rbind(c(-10.101,-10.101,-10.101), c(0.0,0.0,1.0)))
segments3d(rbind(c(-10.101,-10.101,-10.101), c(0.0,0.0,1.0)))
segments3d(rbind(c(-10.101,-10.101,-10.101), c(-10.101,-10.101,-9.101)), col=c("red","red"))
segments3d(rbind(c(0.5,-0.5,0.5), c(0.0,0.0,1.0)))
segments3d(rbind(c(0.5,0.5,0.5), c(0.0,0.0,1.0)))
